...
If you would like to lower the noise in your data, which is helpful for applications in clinical, intervention, or longitudinal data in particular, you might consider instead using our recently developed PC Clocks. You can use  [this code](https://github.com/MorganLevineLab/PC-Clocks) and refer to [this publication](insert-paper-doi-when-published).
