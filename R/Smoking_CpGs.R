#' @title McCartney Smoking Predictor Weights
#'
#' @description The CpGs and Weights to calculate the McCartney Smoking Predictor
#'
#' @format A data frame with 233 rows (CpGs) and 2 variables:
#' \describe{
