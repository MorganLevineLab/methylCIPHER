#' @title McCartney BMI Predictor Weights
#'
#' @description The CpGs and Weights to calculate the McCartney BMI Predictor
#'
#' @format A data frame with 1109 rows (CpGs) and 2 variables:
#' \describe{
